...
${OBJECTDIR}/ptr1.o: ptr1.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ptr1.o ptr1.c

${OBJECTDIR}/ptr2referencia.o: ptr2referencia.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ptr2referencia.o ptr2referencia.c

${OBJECTDIR}/ptr2valor.o: ptr2valor.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ptr2valor.o ptr2valor.c

${OBJECTDIR}/ptr3_forma1_ptrnoconst-datonoconst.o: ptr3_forma1_ptrnoconst-datonoconst.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ptr3_forma1_ptrnoconst-datonoconst.o ptr3_forma1_ptrnoconst-datonoconst.c

${OBJECTDIR}/ptr3_forma2_1_ptrnoconst-datoconst.o: ptr3_forma2_1_ptrnoconst-datoconst.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ptr3_forma2_1_ptrnoconst-datoconst.o ptr3_forma2_1_ptrnoconst-datoconst.c

${OBJECTDIR}/ptr3_forma2_ptrnoconst-datoconst.o: ptr3_forma2_ptrnoconst-datoconst.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ptr3_forma2_ptrnoconst-datoconst.o ptr3_forma2_ptrnoconst-datoconst.c

${OBJECTDIR}/ptr3_forma3_ptrconst-datonoconst.o: ptr3_forma3_ptrconst-datonoconst.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ptr3_forma3_ptrconst-datonoconst.o ptr3_forma3_ptrconst-datonoconst.c

${OBJECTDIR}/ptr3_forma4_ptrconst-datoconst.o: ptr3_forma4_ptrconst-datoconst.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ptr3_forma4_ptrconst-datoconst.o ptr3_forma4_ptrconst-datoconst.c

${OBJECTDIR}/ptr4.o: ptr4.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ptr4.o ptr4.c

${OBJECTDIR}/ptr5_sizeof1.o: ptr5_sizeof1.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ptr5_sizeof1.o ptr5_sizeof1.c

${OBJECTDIR}/ptr5_sizeof2.o: ptr5_sizeof2.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ptr5_sizeof2.o ptr5_sizeof2.c
