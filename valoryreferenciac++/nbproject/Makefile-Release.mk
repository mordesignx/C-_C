...
${OBJECTDIR}/aliasreferencia.o: aliasreferencia.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/aliasreferencia.o aliasreferencia.cpp
...
${OBJECTDIR}/desplazamiento.o: desplazamiento.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/desplazamiento.o desplazamiento.cpp
...
${OBJECTDIR}/lectura_escritura_ficheros.o: lectura_escritura_ficheros.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lectura_escritura_ficheros.o lectura_escritura_ficheros.cpp

${OBJECTDIR}/lectura_escritura_ficheros2.o: lectura_escritura_ficheros2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lectura_escritura_ficheros2.o lectura_escritura_ficheros2.cpp

${OBJECTDIR}/lectura_escritura_ficheros3.o: lectura_escritura_ficheros3.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lectura_escritura_ficheros3.o lectura_escritura_ficheros3.cpp

${OBJECTDIR}/lectura_escritura_ficheros4.o: lectura_escritura_ficheros4.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lectura_escritura_ficheros4.o lectura_escritura_ficheros4.cpp

${OBJECTDIR}/primero.o: primero.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/primero.o primero.cpp

${OBJECTDIR}/primero2.o: primero2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/primero2.o primero2.cpp

${OBJECTDIR}/segundo.o: segundo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/segundo.o segundo.cpp

${OBJECTDIR}/tercero.o: tercero.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tercero.o tercero.cpp
